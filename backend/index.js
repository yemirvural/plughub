function printBooking(booking){
    console.log(`${booking.driver.name} now in ${booking.driver.location} and books ChargeStation at ${booking.station.location} and #${booking.station.location} has ID. (( Driver ---> Status: ${booking.driver.status.state}, ${booking.driver.status.statusCode}, ${booking.driver.status.statusName})) && (( Station ---> Status: ${booking.station.status.state}, ${booking.driver.status.statusCode}, ${booking.driver.status.statusName}))`);
